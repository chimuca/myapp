...
<title>微社（Vshe）后台</title>

<!-- Bootstrap core CSS -->
<link href="${BASE_PATH}/static/res/css/bootstrap.min.css"
	rel="stylesheet">
<link href="${BASE_PATH}/static/res/css/bootstrap-reset.css"
	rel="stylesheet">
<!--external css-->
<link
	href="${BASE_PATH}/static/res/assets/font-awesome/css/font-awesome.css"
	rel="stylesheet" />
<!-- Custom styles for this template -->
<link href="${BASE_PATH}/static/res/css/style.css" rel="stylesheet">
<link href="${BASE_PATH}/static/res/css/style-responsive.css"
	rel="stylesheet" />

<!-- HTML5 shim and Respond.js IE8 support of HTML5 tooltipss and media queries -->
<!--[if lt IE 9]>
    <script src="${BASE_PATH}/static/res/js/html5shiv.js"></script>
    <script src="${BASE_PATH}/static/res/js/respond.min.js"></script>
    <![endif]-->
<script src="${BASE_PATH}/static/res/js/jquery.js"></script>
<script src="${BASE_PATH}/static/res/js/jquery.form.min.js"></script>
<style type="text/css">
p.error {
	color: #DE5959;
}
	...
	<div class="container">
		...
		<form class="form-signin" id="adminForm"
			...
			<h2 class="form-signin-heading">
				<img src="${BASE_PATH}/static/res/images/logo.png"
					style="height: 38px;" />
			</h2>
					...
					.ajaxForm(
							{
								...
								success : function(data) {
									if (data.result) {
										location.href = "${BASE_PATH}/page/index.htm";
									} else {
