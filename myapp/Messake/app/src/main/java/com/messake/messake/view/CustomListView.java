...
/**
 *  ListView下拉刷新和加载更多<p>
 * 默认如果设置了OnRefreshListener接口和OnLoadMoreListener接口，<br>并且不为null，则打开这两个功能了。
...
public class CustomListView extends ListView implements AbsListView.OnScrollListener {
    ...
    /**  headView动画   */
    private android.view.animation.RotateAnimation mArrowAnim;
    /**  headView反转动画   */
    private android.view.animation.RotateAnimation mArrowReverseAnim;
    ...
    private void initPullImageAnimation(final int pAnimDuration) {
        ...
        mArrowAnim = new android.view.animation.RotateAnimation(0, -180,
        ...
        mArrowReverseAnim = new android.view.animation.RotateAnimation(-180, 0,
                android.view.animation.RotateAnimation.RELATIVE_TO_SELF, 0.5f,
                android.view.animation.RotateAnimation.RELATIVE_TO_SELF, 0.5f);
