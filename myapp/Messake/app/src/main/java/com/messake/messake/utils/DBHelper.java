...
import com.messake.messake.dao.AttachmentDao;
import com.messake.messake.dao.ChatMessageDao;
import com.messake.messake.dao.DaoMaster;
import com.messake.messake.dao.DaoSession;
import com.messake.messake.dao.ChatMessageDao.Properties;
import com.messake.messake.dao.TodoDao;
...
public class DBHelper  {
    ...
    public Todo getTodoByTodoId(int todoId, int whoId) {
        ...
        qb.where(com.messake.messake.dao.TodoDao.Properties.TodoId.eq(todoId),
                com.messake.messake.dao.TodoDao.Properties.WhoId.eq(whoId));
    ...
    public int getMaxTodoIdByUserId(int whoId) {
        TodoDao todoDao = daoSession.getTodoDao();
        QueryBuilder<Todo> qb = todoDao.queryBuilder();
        qb.where(com.messake.messake.dao.TodoDao.Properties.WhoId.eq(whoId));
        qb.limit(1);
        qb.orderDesc(com.messake.messake.dao.TodoDao.Properties.TodoId);
        Todo m = qb.unique();
        int maxId = 0;
        if (m != null) {
    ...
    public List<Todo> getTodo(int whoId) {
        ...
        QueryBuilder<Todo> qb = todoDao.queryBuilder();
        qb.where(com.messake.messake.dao.TodoDao.Properties.WhoId.eq(whoId));
        qb.orderDesc(com.messake.messake.dao.TodoDao.Properties.CreateDate);
        List<Todo> todos = qb.list();
        return todos;
    }
    ...
    public Attachment addAttachment(Attachment attachment) {
        ...
        qb.where(com.messake.messake.dao.AttachmentDao.Properties.GroupName
                        .eq(attachment.getGroupName()),
                com.messake.messake.dao.AttachmentDao.Properties.Path.eq(attachment
                        .getPath()));
    ...
    public Attachment getAttachment(String groupName, String path) {
        ...
        qb.where(com.messake.messake.dao.AttachmentDao.Properties.GroupName
                        .eq(groupName),
                com.messake.messake.dao.AttachmentDao.Properties.Path.eq(path));
        Attachment a = qb.unique();
        return a;
    }
    ...
    public Attachment getAttachment(long attachmentId) {
        ...
        QueryBuilder<Attachment> qb = attachmentDao.queryBuilder();
        qb.where(com.messake.messake.dao.AttachmentDao.Properties.Id
                .eq(attachmentId));
        Attachment a = qb.unique();
        return a;
    }
