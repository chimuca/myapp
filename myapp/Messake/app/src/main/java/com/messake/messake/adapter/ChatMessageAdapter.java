...
public class ChatMessageAdapter  extends BaseAdapter implements View.OnClickListener {
    ...
    private View getAttachmentView(int position, View view, ViewGroup parent,
        ...
        if (chatEntity.getType() == ChatMessage.TYPE_SEND) {
            ...
            ViewGroup.LayoutParams lp = rVoiceTime.getLayoutParams();
            lp.width = length;
            ...
            ViewGroup.LayoutParams lp = lVoiceTime.getLayoutParams();
            int w = lp.width;
            lp.width = length;
        ...
        if (chatEntity.getType() == ChatMessage.TYPE_SEND) {
            switch (chatEntity.getStatus()) {
                ...
                case ChatMessage.STATUS_UNKNOWN:
                    msgStatus.setBackground(mContext0.getResources().getDrawable(
                            R.drawable.msg_status_resend_selector));
                    msgStatus.setOnClickListener(new View.OnClickListener() {
                        @Override
    ...
    private View.OnClickListener onPhoto = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
