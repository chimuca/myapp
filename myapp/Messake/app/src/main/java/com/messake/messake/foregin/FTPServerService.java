...
package com.messake.messake.foregin;
...
import com.messake.messake.activity.WiFiActivity;
import com.messake.messake.utils.RemoteUtil;
...
public class FTPServerService extends Service implements Runnable {
    ...
    public void run() {
        ...
        while (!shouldExit) {
            ...
            try {
                // todo: think activity_about using ServerSocket, and just closing
    ...
    private void takeWakeLock() {
        if (wakeLock == null) {
            ...
            // well-complained-activity_about on android-developers.
    ...
    /**
     * The FTPServerService must know activity_about all running session threads so they
