...
import com.messake.messake.adapter.SearchViewPagerAdapter;
...
public class SearchActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle arg0) {
        ...
        searchFriendsTitle.setOnClickListener(new View.OnClickListener() {
        ...
        searchGroupTitle.setOnClickListener(new View.OnClickListener() {
