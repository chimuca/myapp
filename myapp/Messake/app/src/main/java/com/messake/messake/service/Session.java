...
public class Session extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        this.serverPort = 8080;// intent.getIntExtra(Constants.INTENT_EXTRA_SERVER_IP,
        // / 8888);
