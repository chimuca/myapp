...
import com.messake.messake.utils.SystemMethod;
import com.messake.messake.view.WaterView;
...
public class WaterPhotoActivity extends Activity {
    ...
    private void init() {
        ...
        mTiaoZheng.setOnClickListener(new View.OnClickListener() {
    ...
    private class MyOntaouchListener implements View.OnTouchListener {
        int startX;
        int startY;
        int endX;
        int endY;
