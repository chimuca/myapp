...
import org.weishe.weichat.AppException;
...
import org.weishe.weichat.bean.AppVersion;
...
public class UpdateManager {
	...
	public void checkAppUpdate(Context context, final boolean isShowMsg) {
		...
		WeisheApi.getNewestVersion(appVersionHandler);
	}
	...
	private void showNoticeDialog() {
		...
		builder.setMessage("微聊 版本 " + mUpdate.getVersionCode() + "");
	...
	private Runnable mdownApkRunnable = new Runnable() {
		...
		public void run() {
			try {
				String apkName = "weichat_" + mUpdate.getVersionCode()
						+ ".apk";
				String tmpApk = "weichat_" + mUpdate.getVersionCode()
						+ ".tmp";
				// 判断是否挂载了SD卡
				String storageState = Environment.getExternalStorageState();
				if (storageState.equals(Environment.MEDIA_MOUNTED)) {
					savePath = Environment.getExternalStorageDirectory()
							.getAbsolutePath() + "/Weichat/AppVersion/";
	...
	protected AsyncHttpResponseHandler appVersionHandler = new AsyncHttpResponseHandler() {
		...
		public void onSuccess(int statusCode, Header[] headers,
			...
			mUpdate = (AppVersion) JSON.parseObject(data, AppVersion.class);
			if (mUpdate != null) {
